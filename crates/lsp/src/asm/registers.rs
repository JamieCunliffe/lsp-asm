...
pub const AARCH64_REGISTERS: [Register; 64] = [
    ...
    Register::new(&[
        "v1", "v1.8b", "v1.16b", "v1.4h", "v1.8h", "v1.2s", "v1.4s", "v1.2d", "d1", "s1",
    ]),
    Register::new(&[
        "v2", "v2.8b", "v2.16b", "v2.4h", "v2.8h", "v2.2s", "v2.4s", "v2.2d", "d2", "s2",
    ]),
    Register::new(&[
        "v3", "v3.8b", "v3.16b", "v3.4h", "v3.8h", "v3.2s", "v3.4s", "v3.2d", "d3", "s3",
    ]),
    Register::new(&[
        "v4", "v4.8b", "v4.16b", "v4.4h", "v4.8h", "v4.2s", "v4.4s", "v4.2d", "d4", "s4",
    ]),
    Register::new(&[
        "v5", "v5.8b", "v5.16b", "v5.4h", "v5.8h", "v5.2s", "v5.4s", "v5.2d", "d5", "s5",
    ]),
    Register::new(&[
        "v6", "v6.8b", "v6.16b", "v6.4h", "v6.8h", "v6.2s", "v6.4s", "v6.2d", "d6", "s6",
    ]),
    Register::new(&[
        "v7", "v7.8b", "v7.16b", "v7.4h", "v7.8h", "v7.2s", "v7.4s", "v7.2d", "d7", "s7",
    ]),
    Register::new(&[
        "v8", "v8.8b", "v8.16b", "v8.4h", "v8.8h", "v8.2s", "v8.4s", "v8.2d", "d8", "s8",
    ]),
    Register::new(&[
        "v9", "v9.8b", "v9.16b", "v9.4h", "v9.8h", "v9.2s", "v9.4s", "v9.2d", "d9", "s9",
    ]),
    Register::new(&[
