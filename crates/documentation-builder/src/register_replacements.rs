...
pub(crate) const REGISTER_REPLACEMENTS: &[(&str, &RegisterSize, &RegisterKind)] = &[
    ...
    ("<Va><d>", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Va><n>", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vb><d>", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vb><m>", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vb><n>", &RegisterSize::Vector, &RegisterKind::SIMD),
    ...
    ("<Vt2>.B", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt2>.D", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt2>.H", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt2>.S", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt3>.<T>", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt3>.B", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt3>.D", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt3>.H", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt3>.S", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt4>.<T>", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt4>.B", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt4>.D", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt4>.H", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt4>.S", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt>.B", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt>.D", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt>.H", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Vt>.S", &RegisterSize::Vector, &RegisterKind::SIMD),
    ("<Zdn>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zdn>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zdn1>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zdn1>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zdn2>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zdn2>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zdn4>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zdn4>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zdn>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zdn>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zdn>.S", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd1>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd1>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd1>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd1>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd1>.Q", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd1>.S", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd2>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd2>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd2>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd2>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd2>.Q", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd2>.S", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd3>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd3>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd4>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd4>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd4>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd4>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd4>.Q", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd4>.S", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ...
    ("<Zd>.Q", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zd>.S", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn>.<Tb>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ...
    ("<Zda>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zda>.S", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zda>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zda>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ...
    ("<Pd1>.<T>", &RegisterSize::Vector, &RegisterKind::PREDICATE),
    ("<Pd2>.<T>", &RegisterSize::Vector, &RegisterKind::PREDICATE),
    ("<Pg>/<ZM>", &RegisterSize::Vector, &RegisterKind::PREDICATE),
    ...
    ("<PNd>.<T>", &RegisterSize::Vector, &RegisterKind::PREDICATE),
    ("<PNg>/Z", &RegisterSize::Vector, &RegisterKind::PREDICATE),
    ("<PNn>.<T>", &RegisterSize::Vector, &RegisterKind::PREDICATE),
    ("<PNn>", &RegisterSize::Vector, &RegisterKind::PREDICATE),
    ("<PNg>", &RegisterSize::Vector, &RegisterKind::PREDICATE),
    ...
    ("<Pv>/M", &RegisterSize::Vector, &RegisterKind::PREDICATE),
    ("<Pv>", &RegisterSize::Vector, &RegisterKind::PREDICATE),
    ...
    ("<Zm>.Q", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zk>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm1>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm1>.<Tb>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm1>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm1>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm2>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm2>.<Tb>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm2>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm2>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm4>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm4>.<Tb>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm4>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm4>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zm>.D]", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn1>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn1>.<Tb>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn1>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn1>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn1>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn1>.Q", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn1>.S", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn2>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn2>.<Tb>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn2>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn2>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn2>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn2>.S", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn4>.<T>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn4>.<Tb>", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn4>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn4>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn4>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn4>.Q", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zn4>.S", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt>.Q", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ...
    ("<Zn>.Q", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ...
    ("<Pdn>.<T>", &RegisterSize::Vector, &RegisterKind::PREDICATE),
    ...
    ("<Zt1>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt1>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt1>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt1>.Q", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt1>.S", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt2>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt2>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt2>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt2>.Q", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt2>.S", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt3>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt3>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt3>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt3>.Q", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt3>.S", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt4>.B", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt4>.D", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt4>.H", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt4>.Q", &RegisterSize::Vector, &RegisterKind::SCALABLE),
    ("<Zt4>.S", &RegisterSize::Vector, &RegisterKind::SCALABLE),
